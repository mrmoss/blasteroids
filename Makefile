...
simulator: simulator.cpp msl/json.cpp msl/socket.cpp msl/time.cpp msl/xmlhttp.cpp msl/jsoncpp/json_reader.cpp msl/jsoncpp/json_tool.h msl/jsoncpp/json_value.cpp msl/jsoncpp/json_writer.cpp
	$(CXX) $(CFLAGS) $^ -o $@ $(LIBS)
